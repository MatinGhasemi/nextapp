...
const OpenFashion = () => {
    return ( 
        <div className="max-w-[440px] mx-auto flex flex-col items-center px-3">
            <div className="italianno text-3xl mb-4">
                <p className="text-right">Open</p>
                <p>Fashion</p>
            </div>
            <p className="font-serif text-background text-lg">Making a luxurious lifestyle accessible for a generous group of women is our daily drive.</p>
            <div className="text-sm text-background grid grid-cols-2 py-5 gap-y-10 px-2">
                <div>
